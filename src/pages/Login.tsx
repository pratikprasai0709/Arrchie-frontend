...
import { ShieldAlert, Lock, Mail, Users, Compass } from 'lucide-react';
...
export default function Login() {
  ...
  const handleQuickCredential = (role: 'admin' | 'user') => {
    clearError();
    if (role === 'admin') {
      setEmail('admin@bottle.com');
      setPassword('admin123');
    } else {
      setEmail('user@bottle.com');
      setPassword('user123');
    }
  };
